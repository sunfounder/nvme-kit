...
NVMe Kit is a hardware kit for Raspberry Pi, which can be used to read and write NVMe SSDs. It is compatible with Raspberry Pi 5/4B/4A/3B+/3B/3A+/2B/Zero 2/W.
